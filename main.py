...
async def index():
    return air.layouts.mvpcss(
        ...
        air.Article(
            air.Section(
                air.P('Interact with ', air.A('Air web framework', href='https://airdocs.fastapicloud.dev/'),  ' tools to expedite project development.', style='text-align: center'),
                air.Aside('https://airmcp.fastapicloud.dev/mcp', class_="copy-on-click"),
                air.P(air.Small('Click the URL to copy it'), style='text-align: center')
                )
        ),
        air.Children(air.Script("""
